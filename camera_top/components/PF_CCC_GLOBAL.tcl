# Exporting Component Description of PF_CCC_GLOBAL to TCL
# Family: PolarFireSoC
# Part Number: MPFS095T-1FCSG325E
# Create and Configure the core component PF_CCC_GLOBAL
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:2.2.222} -component_name {PF_CCC_GLOBAL} -params {\
...
# Exporting Component Description of PF_CCC_GLOBAL to TCL done
